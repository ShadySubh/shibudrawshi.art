    ...
    <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col gap-7">
      ...
      <div className="flex flex-col gap-4 border-b border-[#d8ceba] pb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            <p className="font-mono text-[9px] uppercase tracking-[0.22em] text-[#a08060] mb-1">Portfolio · 02</p>
            <h1 className="font-serif text-4xl font-bold text-[#2c2416]">Graphic Designs</h1>
            <p className="mt-1 font-mono text-[10px] text-[#a08060]">{designProjects.length} projects</p>
          </div>
      ...
      <div className="columns-1 sm:columns-2 lg:columns-3 gap-4">
        {designProjects.map((project, i) => (
          <div
            ...
            className="group relative border border-[#d8ceba] bg-[#faf6ee]/80 overflow-hidden card-hover mb-4 break-inside-avoid"
          >
            <div className="relative w-full overflow-hidden bg-[#ede6d6]" style={{ aspectRatio: "4/5" }}>
              <Image
                src={project.src}
                alt={project.title}
                fill
              ...
              />
              {/* Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-[#2c2416]/60 via-[#2c2416]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-3">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-serif text-[12px] font-semibold text-[#f5f0e8]">{project.title}</p>
                    <p className="font-mono text-[9px] text-[#f5f0e8]/60 uppercase">{project.category}</p>
                  </div>
                  <ExternalLink className="w-3.5 h-3.5 text-[#f5f0e8]/60" />
                </div>
              </div>
            ...
            <div className="p-2.5 border-t border-[#d8ceba] flex flex-wrap gap-1">
      ...
      <div className="border border-[#d8ceba] bg-[#faf6ee]/80 p-8 text-center">
        ...
        <h2 className="font-serif text-xl font-semibold text-[#2c2416] mb-2">Need a design?</h2>
        <p className="font-sans text-sm text-[#6b5e4a] mb-4">Let&apos;s create something beautiful together.</p>
        <Link href="/contact" id="design-cta-contact" className="inline-flex items-center gap-2 px-5 py-2.5 border border-[#d8ceba] text-[#2c2416] font-sans text-sm hover:border-[#2c2416] hover:bg-[#ede6d6] transition-colors">
